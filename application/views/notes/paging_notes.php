<div class="col-12 float-right">
	<nav class="d-inline-block">
		<ul class="pagination">
			<?php
			$showPage = 0;
			if ($noPage > 1) echo  "<li class='page-item active'><a class='page-link' href='javascript:void(0)' onClick=\"getTweet('".($noPage-1)."')\" >Prev Notes</a></li>";
			...
			if ($noPage < $jumPage) echo "<li class='page-item active'><a class='page-link' href='javascript:void(0)' onClick=\"getTweet('".($noPage+1)."')\">More Notes</a></li>";
			?>
		</ul>
	</nav>
</div>